...
tok_clean <- tokens_remove(tok_tweet, pattern = stopwords("english"))
stopwords_2 <- c("dass", "„", "–", "1/2", "¿", "*ï*", "ua", "nsche", "ch", "sterreich", "cke", "kologische", "mpfen", "nnen", "ssen", "rgern", "re", "ckwunsch", "rlich", "d")
