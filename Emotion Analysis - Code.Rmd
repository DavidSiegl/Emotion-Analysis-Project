...
textplot_wordcloud(dfm_trim(comp_dfm, dmin_count = 5, verbose = FALSE), max_words = 140, min_size = 1.2, min_count = 5, labelcolor = "black", rotation = 1,
